...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET['bookdate'])) {$bookdate = $_GET['bookdate']; } 
    if (isset($_GET['bookmap'])) {$bookmap = $_GET['bookmap']; } 
    if (isset($_GET['bookdesk'])) {$bookdesk = $_GET['bookdesk']; } 
}
