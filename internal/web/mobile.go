...
func (app *Server) handleMobile(w http.ResponseWriter, r *http.Request) {
...
// fresh cache name.
func (app *Server) handleMobileServiceWorker(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleMobileManifest(w http.ResponseWriter, r *http.Request) {
	title := app.appTitle()
	short := title
	if len(short) > 12 {
		short = short[:12]
