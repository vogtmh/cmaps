...
func (app *Server) handleRestDesks(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) appendIfMatch(items *[]deskItem, item deskItem, search, extraName string) {
	if search == "" {
