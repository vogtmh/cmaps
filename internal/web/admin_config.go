...
func (app *Server) handleAdminPostItemTypes(r *http.Request, sess Session) string {
...
func (app *Server) handleAdminPostConfig(r *http.Request, sess Session) string {
...
func (app *Server) saveItemTypeFromForm(r *http.Request, sess Session) string {
...
func (app *Server) saveItemIcon(id string, fh *multipart.FileHeader) error {
	src, err := fh.Open()
	if err != nil {
		return err
	}
...
func (app *Server) saveLogosFromForm(r *http.Request, sess Session) string {
...
func (app *Server) saveLogoImage(name string, fh *multipart.FileHeader) error {
	src, err := fh.Open()
	if err != nil {
		return err
	}
...
func (app *Server) handleRestSetting(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) vipCategoriesPayload() []map[string]interface{} {
...
// never has to reload).
func (app *Server) handleRestVips(w http.ResponseWriter, r *http.Request) {
	sess, ok := app.currentSession(r)
