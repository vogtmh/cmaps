...
func (app *Server) requireAdmin(w http.ResponseWriter, r *http.Request) (Session, bool) {
...
func (app *Server) handleSetup(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleSetupDemo(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
...
func (app *Server) handleSetupImport(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
	c := MySQLConfig{
...
func (app *Server) handleSetupImportProgress(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
...
func (app *Server) handleSetupDataCopy(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
...
func (app *Server) handleSetupLdap(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
...
func (app *Server) handleSetupRobin(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
	if r.FormValue("skip") != "1" {
...
func (app *Server) handleSetupFinish(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.requireAdmin(w, r); !ok {
		return
	}
