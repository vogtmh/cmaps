...
func (app *Server) seedDemoData() error {
	db := app.db
...
func (app *Server) createDemoData() error {
	for _, d := range []string{"- none -", "Development", "Sales", "Marketing", "Finance", "HumanResources", "IT-Administration", "Support"} {
...
func (app *Server) removeDemoData() error {
...
func (app *Server) copySampleMap(sampleName, mapName string) error {
...
func (app *Server) copySampleAvatar(sampleName, userid string) error {
