...
// feature permission.
func (app *Server) handleRestSystem(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) checkLdapConsistency() (int, []map[string]interface{}, []string) {
...
func (app *Server) duplicateDeskGroups() ([]deskGroup, []string) {
...
func (app *Server) checkDeskConsistency() (int, []map[string]interface{}, []string) {
...
func (app *Server) whitelistFor(kind string) []string {
