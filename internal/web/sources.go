...
// already at the edge.
func (app *Server) moveSource(ref string, dir int) bool {
...
func (app *Server) setSourceFlags(ref string, assign, keepDup *bool) {
	rules := app.currentRules()
	for i := range rules {
		if rules[i].Ref == ref {
			if assign != nil {
...
func (app *Server) robinConfigured() bool {
...
func (app *Server) listUnifiedSources() []UnifiedSource {
...
func (app *Server) handleRestSourceSeats(w http.ResponseWriter, r *http.Request) {
