...
// trigger a sync.
func (app *Server) startIntegrationHealthScheduler(first, interval time.Duration) {
	go func() {
...
// cached result map.
func (app *Server) runIntegrationTests() {
...
func (app *Server) testLdapIntegration() intgHealthResult {
...
func (app *Server) testEntraIntegration() intgHealthResult {
...
func (app *Server) testRobinIntegration() intgHealthResult {
...
func (app *Server) testSamlIntegration() intgHealthResult {
	cfg := app.cfg.SAML
	if !cfg.Enabled {
...
func (app *Server) handleRestDashboard(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) dashboardPermitted(r *http.Request) bool {
	sess, ok := app.currentSession(r)
...
func (app *Server) handleRestDashboardOverview(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleRestDashboardSystem(w http.ResponseWriter, r *http.Request) {
	if !app.dashboardPermitted(r) {
		http.Error(w, "forbidden", http.StatusForbidden)
		return
	}
...
func (app *Server) handleRestDashboardIntegrations(w http.ResponseWriter, r *http.Request) {
	if !app.dashboardPermitted(r) {
		http.Error(w, "forbidden", http.StatusForbidden)
		return
	}
...
func (app *Server) handleRestDashboardVisitors(w http.ResponseWriter, r *http.Request) {
	if !app.dashboardPermitted(r) {
		http.Error(w, "forbidden", http.StatusForbidden)
		return
	}
...
func (app *Server) dashboardSystem() map[string]interface{} {
	host, _ := os.Hostname()
...
func (app *Server) dashboardIntegrations(health map[string]intgHealthResult) []map[string]interface{} {
...
func (app *Server) dashboardOverview() map[string]interface{} {
...
func (app *Server) dashboardVisitors() []map[string]interface{} {
...
func (app *Server) nowLocal() string {
