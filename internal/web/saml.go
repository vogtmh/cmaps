...
func (app *Server) samlEntityID(r *http.Request) string {
...
func (app *Server) samlACSURL(r *http.Request) string {
...
func (app *Server) handleSAMLMetadata(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleSAMLLogin(w http.ResponseWriter, r *http.Request) {
	cfg := app.cfg.SAML
	if !cfg.Enabled {
...
func (app *Server) handleSAMLLogout(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleSAMLACS(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleSAMLStatus(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleSAMLValidate(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	cfg := app.cfg.SAML
...
func (app *Server) handleSAMLSettings(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	switch r.Method {
	case http.MethodGet:
...
func (app *Server) handleSAMLSPInfo(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (app *Server) handleSAMLDebugLast(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (app *Server) handleSAMLMyCapture(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (app *Server) handleSAMLImportMetadata(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	if r.Method != http.MethodPost {
		http.Error(w, "method not allowed", http.StatusMethodNotAllowed)
		return
