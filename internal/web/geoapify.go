...
func (app *Server) geoEnabled() bool { return app.geo.Enabled() }
...
func (app *Server) geoValidate(ctx context.Context) map[string]interface{} {
...
func (app *Server) geoTestPayload(checks []testCheck) map[string]interface{} {
