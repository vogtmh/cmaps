...
func (app *Server) handleRestUsers(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleRestConfig(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleRestTeams(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleRestAuditlog(w http.ResponseWriter, r *http.Request) {
...
func (app *Server) handleRestChanges(w http.ResponseWriter, r *http.Request) {
	q := r.URL.Query()
	offset := atoiDefault(q.Get("offset"), 0)
	if offset < 0 {
		offset = 0
...
func (app *Server) handleRestStats(w http.ResponseWriter, r *http.Request) {
